...
public static class StartupExtensions
{
    ...
    {
        configureSwaggerGen = configureSwaggerGen ?? GetDefaultSwaggerGenOptions();
        ...
        Action<SwaggerUIOptions>? configureSwaggerUI = null)
    {
        return app
            .UseSwagger(configureSwagger)
            .UseSwaggerUI(configureSwaggerUI ?? GetDefaultSwaggerUIOptions())
            .UseJsonRpc(configureRpc);
    }
    ...
    {
        return c => c.SwaggerDoc("rpc/v1", new OpenApiInfo
        {
            Title = "My API V1",
            Version = "rpc/v1"
        });
    ...
    {
        return c => c.SwaggerEndpoint("/swagger/rpc/v1/swagger.json", "My API V1");
    }
}